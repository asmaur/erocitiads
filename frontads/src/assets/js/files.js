...
$(document).ready(function(){
        ...
        function RenderThumbnail(e, readerEvt)
        {
            ...
            ul.appendChild(li);
            li.innerHTML = ['<div class="img-wrap col-md-3"> <span class="close">&times;</span>' +
                '<img class="thumb img-fluid" src="', e.target.result, '" title="', escape(readerEvt.name), '" data-id="',
