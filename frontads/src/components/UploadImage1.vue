<template>
   <form v-bind:id="'upload_image_form--' + input_id" enctype="multipart/form-data" style="border: 1px solid blue;">
    <div class="vue_component__upload--image"  style="min-height: 20vh; border: 1px solid red;">
            ...
            <input type="file" v-bind:id="'upload_image_form__input--' + input_id"  multiple />
            <div>
               <!-- <button type="submit"
