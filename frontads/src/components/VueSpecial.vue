              ...
              <div class="form-group col-md-4 text-left">
                <div class="custom-control custom-checkbox">
                  <input
                    ...
                    class="custom-control-input"
                    id="chuva_dourada"
                    v-model="especiais.chuva_dourada"
                    name="chuva_dourada"
                    style
                  >
              ...
              <div class="form-group col-md-4 text-left">
                <div class="custom-control custom-checkbox">
                  <input
                    ...
                    class="custom-control-input"
                    id="garganta"
                    v-model="especiais.garganta_profunda"
                    name="garganta"
                    style
                  >
